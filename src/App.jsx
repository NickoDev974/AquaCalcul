  ...
  return (
    <>
      ...
      <section className="volume">
        ...
        <p>Combien de litres dans mon aquarium ou bassin ?</p>
        ...
        <article>
          ...
          {volumeCube && (
            <p>
              Le volume de votre aquarium cubique est de {volumeCube} litres.
            </p>
          )}
        </article>
        <article>
          ...
          {volumeCylinder && (
            <p>
              Le volume de votre aquarium cylindrique est de {volumeCylinder}{" "}
              litres.
            </p>
          )}
        </article>
      ...
      {requiredTreatment && (
        <p>Vous avez besoin de {requiredTreatment} ml de traitement.</p>
      )}

      {/* Section calcul de la bâche */}
      <h2>Calcul de bâche</h2>
      <p>Calcul de la taille de la bâche nécessaire pour un bassin cubique.</p>
      ...
      {bacheLength && bacheWidth && bacheHeight && (
        <p>
          ...
          {(parseFloat(bacheLength) + 1 + parseFloat(bacheHeight) * 2).toFixed(
            2
          )}{" "}
          m de longueur et{" "}
      ...
      {bacheRealLength && bacheRealWidth && (
        <p>
          Vous devrez couper une bâche de {bacheRealLength} m de longueur sur
          une largeur de {bacheRealWidth} m (en fonction des largeurs
          disponibles : 4m, 6m, 8m, 10m).
        </p>
      )}
      ...
      {surfaceToPaint && (
        <p>La surface totale à peindre est de {surfaceToPaint} m².</p>
      )}
    </>
  );
}
